...
- `courses/xingcao/` 「行草書法之路」→ https://xingcao-course.pages.dev (11 章 40 單元,二王/米芾/黃庭堅/孫過庭;骨幹陳忠建逐字系列+黃簡講書法)
...
- 五門課的 Cloudflare Pages 專案名:`landnav` / `jazz-trumpet` / `jazz-tenor-sax` / `jazzpiano-course` / `xingcao-course`(production branch `main`,wrangler 手動部署;**第一次部署前要先 `wrangler pages project create`**)
...
- **xingcao**(2026-08-08):40 單元/140 延伸,verify 180/180+43/43;0 留白;實證 0 strong、「書法靜心養生」contested;evidenceAlias 可指向 concept-* 條目(本課首用:四家開篇對映四條立場)
